(function (sf, cjs) {
  ...
  p.start = function () {
    ...
    this.view.sndEnd.gotoAndStop(0);
  ...
  p.cardsArrange = function () {
    for (var i = 1; i <= 12; i++) {
      ...
      card_mc.name = wdList1[cardsListSorted1[i - 1][0] - 1];
      card_mc.case = cardsListSorted1[i - 1][1];
      //console.log(card_mc.name + "////name");
      if (cardsListSorted1[i - 1][1] == "c") {}
      cardObjArr.push(card_mc);

      this.view.addChild(card_mc);
      card_mc.removeAllEventListeners("click");
      ...
      .call(
        function () {
          for (var i = 1; i <= 12; i++) {
            ...
            cardObjArr[i - 1].num = cardsListSorted1[i - 1][0];
            // console.log(cardsListSorted1[i - 1][0] + "//////////////")
            cardObjArr[i - 1].randomShape.gotoAndStop(
              cardsListSorted1[i - 1][0]
            );

            if (cardsListSorted1[i - 1][1] == "s") {
              cardObjArr[i - 1].randomShape[
                "letter" + cardsListSorted1[i - 1][0]
              ].gotoAndStop(0);

              cardObjArr[i - 1].randomShape[
                "cletter" + cardsListSorted1[i - 1][0]
              ].visible = false;
              cardObjArr[i - 1].xPos =
                cardObjArr[i - 1].randomShape[
                  "letter" + cardsListSorted1[i - 1][0]
  ...
  p.rndList = function () {
    ...
    for (var i = 0; i < 6; i++) {
      ...
      this.loadWordSound(wdList1[__arr[i] - 1] + "SndCp");
  ...
  p.cardClicks = function (e) {
    ...
    if (presentCard.case == "s") {
      ...
      var letter = presentCard.name.charAt(0);
      //Fix: ABCs-misc-bugs-20190622
      if (letter == "q") {
        playSound(letter + "Snd");
      } else {
        playSound(letter + "SndCp");
      }
      presentCard.randomShape[
        "cletter" + presentCard.randomShape.currentFrame
      ].gotoAndStop(8);
      cjs.Tween.get({})
        .wait(400)
        .call(
    ...
    cjs.Tween.get({})
      ...
      .call(
        function () {
          ...
          tempCard_mc.y = tempY;
          tempCard_mc.alpha = 1;
          tempCard_mc.front.visible = false;
      ...
      .call(
        function () {
          ...
          cjs.Tween.get(tempCard_mc.randomShape["cletter" + presentCard.num])
            .to({
              scaleX: 1.1,
              scaleY: 1.1
            }, 300)
          ...
          cjs.Tween.get(tempCard_mc)
            ...
            .call(
              function () {
                ...
                tempCard_mc.x = this.view["target" + match_cnt].x;
                tempCard_mc.y = this.view["target" + match_cnt].y;
  ...
  p.gameEndHandler = function () {
    //playSound("youdidit");
    this.view.sndEnd.gotoAndPlay(1);
    createjs.Tween.get({})
      .wait(500)
      .call(function () {
        stars.startEmit();
