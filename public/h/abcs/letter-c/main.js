(function (Main) {
  ...
  Main.initVideo = function () {
    var $video = $(
      '<video id="player" controls playsinline class="vjs-default-skin vjs-big-play-centered" style="height: 100%;width:100%;" data-setup=\'{ "nativeControlsForTouch": false }\'/>'
    );
